...
150,000 solar system objects.  \citet{galluccio2022} published the first
...
\citep{galluccio2022}, downloaded as a single 823\,MB Parquet file
...
\midrule
Gaia DR3 SSO        & \citet{galluccio2022}   & 128\,885 & 100.0 & $H$, $G$, $\sigma_G$, $n_\mathrm{obs}$, phase\_range \\
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{gapc_fig5_size_law.pdf}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{48_gapc_gasp_crossmatch.pdf}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{gapc_fig4_binary.pdf}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{gapc_fig3_completeness.pdf}
